        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-lg font-extrabold text-slate-900">Kucekin</span>
            </div>
            <p className="text-sm text-slate-500 leading-relaxed mb-6">
              Solusi laundry profesional untuk membantu Anda merawat pakaian dengan kualitas terbaik dan tepat waktu.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              {['Tentang Kami', 'Kontak', 'Layanan', 'Karir'].map(item => (
                <a key={item} href="#" className="text-sm text-slate-500 hover:text-slate-900 transition-colors">{item}</a>
              ))}
            </div>
          </div>
